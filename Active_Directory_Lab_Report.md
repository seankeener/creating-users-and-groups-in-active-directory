...
1. **Created a User**
   ...
   - Navigated to the appropriate *Organizational Unit (OU)*.
...
## Notes
This lab demonstrates fundamental administrative operations in Active Directory related to user and group management.
